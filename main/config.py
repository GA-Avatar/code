...
class Config:
    ...
    # output_dir = osp.join(root_dir, 'output_00034')
    ...
    def set_args(self, subject_id, continue_train=False, output_dir='output'):
        self.subject_id = subject_id
        self.continue_train = continue_train
        cfg.output_dir = output_dir
        cfg.model_dir = osp.join(self.output_dir, 'model_dump')
        cfg.vis_dir = osp.join(self.output_dir, 'vis')
        cfg.log_dir = osp.join(self.output_dir, 'log')
        cfg.result_dir = osp.join(self.output_dir, 'result')
